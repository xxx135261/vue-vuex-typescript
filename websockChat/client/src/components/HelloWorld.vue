...
export default {
  ...
  methods: {
    ...
    scrollBottm() {
      ...
      el.scrollTop = el.scrollHeight;
		...
		socketHeart(){
			...
			setInterval(()=>{
				//如果已经关闭就停止
				console.log('心跳狀態'+_this.ws.readyState)
    ...
    initWebSocket() {
      ...
      if (window.WebSocket) {
        // 192.168.1.187:8181 是我本地node起的服务
        let ws = new WebSocket("ws://192.168.1.187:8181");
				_this.ws = ws;
				//监听连接成功
