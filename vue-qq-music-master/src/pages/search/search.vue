          ...
          <div class="search-results" v-show="isShowSearchResults">
                <div class="song-list">
                    <div class="song-item" 
                        ...
                        <div class="song-artist"><span v-for="(artist,index) in list.singer" :key="index" v-html="artist.name+'&nbsp;'"></span></div>
                        <div class="icon-love" @click.stop="addLoves(list.songname)"></div>
                    </div>
                </div>
...
export default class search extends Vue {
    ...
    @Action('setLocalStorageData2') setLocalStorageData2;
    ...
    mounted() {
        ...
        this.history = localStorage.getItem('SET_HISTORY_KEY')
            ...
            : [];
        // 收藏记录
        this.loves = localStorage.getItem('SAVE_LOVE')
            ? localStorage.getItem('SAVE_LOVE').split(',')
            : [];
    }
    ...
    // 添加收藏
     addLoves(keyword) {
        ...
        let index = this.loves.indexOf(keyword);
        if (index && index === -1) {
            this.loves.unshift(keyword);
            this.setLocalStorageData2(this.loves);
        }
    }
