            ...
            <div class="player-container">
                ...
                <div class="player-lyrics">
                    <div class="player-lyrics-lines" ref="lyricsLines">
                        <div class="player-lyrics-line" v-for="(list,index) in lyrics" :key="index" v-show="lyrics.length !== 0">{{list.slice(10)}}</div>
...
// vue-property-decorator是在vue-class-component上增强了更多的结合vue特性的装饰器
...
export default class Player extends Vue {
    ...
    */
    ...
    // 计算属性compued : isShowPlayer、isPlay、
    get isShowPlayer() {
